...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?php echo base_url(); ?>/assets/dist/img/baru.JPG" alt="baru"
                height="60" width="60">
        </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; Pemograman Web <a href="https://adminlte.io">Ilmu Komputer Belajar
                    web</a>.</strong>
            Class:)
